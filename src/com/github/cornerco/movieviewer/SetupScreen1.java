 ...
 * @author  Peter Hoek
 */
public class SetupScreen1 extends javax.swing.JFrame {
    ...
    public SetupScreen1(MovieViewer mv) {
        this.mv = mv;
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        SetupScreen s = new SetupScreen(mv);
        s.setLocationRelativeTo(mv);
        s.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        SelectFile sf = new SelectFile(mv);
        sf.setVisible(true);
        this.dispose();
